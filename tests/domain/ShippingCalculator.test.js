const ShippingCalculator = require('../../src/domain/services/ShippingCalculator');
...
describe('ShippingCalculator', () => {
    ...
    it('should return DEFAULT fee when region is null or undefined', () => {
        expect(ShippingCalculator.calculateFee(null)).toBe(35000);
        expect(ShippingCalculator.calculateFee(undefined)).toBe(35000);
